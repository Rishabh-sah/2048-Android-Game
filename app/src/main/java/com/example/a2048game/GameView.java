...
public class GameView extends GridLayout {
    ...
    private void checkGameOver() {
        ...
        if (isOver) {
            new AlertDialog.Builder(getContext()).setTitle("Game Over").setMessage("Score"+MainActivity.score).setPositiveButton("Play Again", new DialogInterface.OnClickListener() {
                @Override
